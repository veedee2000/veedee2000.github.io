        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <span style={{style:"black"}}><a className="resume" href="https://drive.google.com/file/d/1_rOUs-EnSnC_Q1TRzC6ahSBn1mKx6Xne/view?usp=sharing" target="_blank">RÉSUME</a></span>
            </div>
            ...
            <div className="colorlib-footer">
              <p><small>
                  Made with <i className="icon-heart" aria-hidden="true" /> by <strong>VD</strong>
              </small></p>
            </div>
          </aside>
        </div>
